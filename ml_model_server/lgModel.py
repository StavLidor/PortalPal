...
#     writer.writerows(
#         [
#             ['Case_No', 'A1', 'A2', 'A3', 'A4', 'A5', 'A6', 'A7', 'A8', 'A9', 'A10', 'Age', 'Qchat-10-Score',
#              'Sex',
...
def get_aq_prediction(data_string, model):
    test_string = StringIO(
        ...
        # 'Case_No,A1,A2,A3,A4,A5,A6,A7,A8,A9,A1,Age,Qchat-10-Score,Sex,Ethnicity,Jaundice,Family_mem_with_ASD,'
