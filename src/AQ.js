        ...
        <div>
            ...
            <Form.Group>
                    <Container className='m-3' style={{width:'700px'}} >
                        ...
                        <Row>
                            ...
                            <Col md="auto">
                                <Form.Group className="mb-3">
                                    <Form.Select id='type' onChange={e => {
                                    ...
                                    >
                                        <option style={{fontSize: 18}} id='title3' value="adult">מבוגרים (18 ומעלה)</option>
                                        <option style={{fontSize: 18}} id='title4' value="children">ילדים (4-11)</option>
                                    </Form.Select>
                                </Form.Group>
                            </Col>
                        </Row>
                            ...
                            <Col md="auto">
                                <Form.Group className="mb-3">
                                    ...
                                    >
                                        ...
                                        <option style={{fontSize: 18}} id='Pacifica' value="Pasifika">פסיפיקה,קליפורניה
                                        </option>
                        ...
                        <Row>
                            ...
                            <Col md="auto">
                                <Form.Group className="mb-3">
                                    <ButtonGroup className="gap-3"><Form.Text style={{fontSize: 20}}>כן</Form.Text>
                            ...
                            <Col md="auto">
                                <Form.Group className="mb-3">
                                    <ButtonGroup className="gap-3">
                                        ...
                                        <Form.Check style={{fontSize: 20}} type="radio" name='memberFamilyWithAsd' required
                                                    onChange={e => setDetails({...details, Family_mem_with_ASD: 'yes'})}
                                        />
                                        <Form.Text style={{fontSize: 20}}>לא</Form.Text>
                                        <Form.Check style={{fontSize: 20}} type="radio" name='memberFamilyWithAsd'
            ...
            <Form className="col justify-content-center">
                <Form.Group>
                    <Table className="table-responsive border-dark" striped bordered hover size="md" >
                        ...
                        {modelType === 'children' && <AQ10ChildrenForm details={details} setDetails={setDetails}/>}
                    </Table>
                </Form.Group>
            </Form>
        </Container>
            ...
            <Container className='align-self-center' style={{alignSelf: 'center'}}>
                <Row className='w-50 align-self-center'>
                    ...
                    <ButtonGroup className='align-self-center'>
                        <Col className={1}><Form.Label
                            style={{fontWeight: 'normal', fontSize: 24,}}>{'התוצאת המודל החכם:  '}</Form.Label></Col>
                        <Col className={1}> <Form.Label
